...
from rank_selection import estimate_rank_for_compression_rate, estimate_vbmf_ranks
...
def get_tucker_factors(layer, rank, cin, cout, kernel_size, **kwargs):
    ...
    print("Weights", weights.shape, "kernel_size", kernel_size)

    core, (U_cout, U_cin, U_dd) = tucker.hooi(dtensor(weights),
                                              [rank[0],
                                               rank[1],
